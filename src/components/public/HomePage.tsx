        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-24">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="order-1 lg:order-2">
              ...
              <ul className="mt-6 space-y-3">
                {['Browse a curated bank of skilled agents', 'Post job listings with direct apply links', 'Message agents directly through the platform', 'Monthly fee of just 3,000 HTG ($20 USD)'].map(t => (
                  <li key={t} className="flex items-center gap-2 text-sm text-gray-700">
                    <CheckCircle2 className="h-4 w-4 text-[#16A34A] shrink-0" />{t}
                  </li>
                ))}
