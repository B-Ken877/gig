    ...
    <div className="space-y-6">
      ...
      {providers.length === 0 ? (
        <Card><CardContent className="py-12 text-center text-gray-400">
          ...
          <p className="text-xs mt-1">When someone gives you a job to post, add them here for tracking.</p>
        </CardContent></Card>
      ) : (
        ...
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <Label>Name *</Label>
              <Input value={form.name} onChange={e => setForm(f => ({ ...f, name: e.target.value }))} placeholder="Miguel Sanchez" />
            </div>
            <div className="space-y-2">
              <Label>Phone</Label>
            ...
            <div className="space-y-2">
              <Label>Email</Label>
              <Input type="email" value={form.email} onChange={e => setForm(f => ({ ...f, email: e.target.value }))} placeholder="miguel@email.com" />
            </div>
            <div className="space-y-2">
              <Label>Notes</Label>
